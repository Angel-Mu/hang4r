...
const USER_KEYS: Record<string, KeySpec> = {
  ...
  claudeEffort: { path: 'agents.claude.effort', codec: 'str', workspaceScoped: false },
  codexEffort: { path: 'agents.codex.effort', codec: 'str', workspaceScoped: false },
  claudeUltracode: { path: 'agents.claude.ultracode', codec: 'bool', workspaceScoped: false },
